...
function makeQuote()
{
    ...
    $("#tweet-quote").attr("href", 'https://twitter.com/intent/tweet?hashtags=ivyli&text=' + encodeURIComponent('"' + quotelist[statvalue].quote + '" ' + quotelist[statvalue].author + ' getquotes.netlify.com/'));
}
